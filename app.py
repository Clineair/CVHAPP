...
# ────────────────────────────────────────────────
    ...
    heli_fuel_pct = st.slider("Heli Fuel Tank % Full", 0, 100, 0)   # default 0%
    truck_fuel_pct = st.slider("Truck Fuel % Full", 0, 100, 0)     # default 0%
    ...
    # ── HELI2 ONLY: Exact Axle Load Status ──
    if selected == "Heli2":
